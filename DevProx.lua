...
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙لا يمكن تنزيل المالك الاساسي") return false;end;end;end,nil)
...
ReplyStatus(msg,result.id_,"Reply","⌁︙لا يمكن تنزيل المالك الاساسي") return false;end;end;end,nil)
